#   Below is my fifth attempt at a cookie clicker algorithm. Seeing how many cookies per second we can reach in 5 mins!
#   This attempt buys the most expensive available upgrade after each 10 second interval... Longer than the previous
#   interval! Let's see if it makes an impact!
#   My C/S score for this attempt was 105.4. Not bad! But not the best.
