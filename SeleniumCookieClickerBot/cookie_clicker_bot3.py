...
#   This attempt buys the most expensive available upgrade after each 2.5 second interval... Shorter than the previous
#   interval! Let's see if it makes an impact!
#   My C/S score for this attempt was 58.4... DOWN from last attempt
...
timeout = time.time() + 2.5       # TWO AND A HALF SECOND TIMER
...
while keep_going:
    ...
    if time.time() > timeout:
        ...
        try:
            ...
            timeout = time.time() + 2.5   # basically resets the 2.5-second cycle timer
